...
{	
	...
	{
		AbstractMinimaxSearch<TicTacToeNode> search = 
			new AlphaBetaSearch<TicTacToeNode>(
					new HashingMinimaxSearch<TicTacToeNode>(
							new DLMinimax<TicTacToeNode>(problem, 9)));
		TicTacToeNode initialNode = new TicTacToeNode(initialState);
	...
	{		
		AbstractMinimaxSearch<TicTacToeNode> search = 
			new AlphaBetaSearch<TicTacToeNode>(
					new HashingMinimaxSearch<TicTacToeNode>(
							new DLMinimax<TicTacToeNode>(problem, 1)));
		TicTacToeNode initialNode = new TicTacToeNode(winnableState);
		TicTacToeNode n = search.search(initialNode);
	...
	{
		IterativeDeepeningSearch<TicTacToeNode> search = 
			new IDTreeSearch<TicTacToeNode>(new DLMinimax<TicTacToeNode>(problem, 0),5000);
		TicTacToeNode initialNode = new TicTacToeNode(initialState);
