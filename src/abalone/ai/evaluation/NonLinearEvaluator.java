...
public class NonLinearEvaluator implements GeneticIndividual, Evaluator<Double>
{
	...
	public NonLinearEvaluator(Genotype phenotype)
	{
	...
	public GeneticIndividual reproduceWith(GeneticIndividual j)
	{
		...
		return new NonLinearEvaluator(newPhenotype);
	}
